            ...
            <div class="col-md-4 d-flex pl-md-5">
                <div class="row">
                    <div class="dbox w-100 d-flex">
                        ...
                        <div class="text">
                            <p><span><?php echo aboutAlamat(1) ?></span><?php echo aboutDesAlamat(1) ?></p>
                        </div>
                    </div>
                    <div class="dbox w-100 d-flex">
                        <div class="icon d-flex align-items-center justify-content-center">
                        ...
                        <div class="text">
                            <p><span><?php echo aboutPhone(1) ?></span> <a href="tel://1234567920"><?php echo aboutDesPhone(1) ?></a></p>
                        </div>
                    </div>
                    <div class="dbox w-100 d-flex">
                        <div class="icon d-flex align-items-center justify-content-center">
                        ...
                        <div class="text">
                            <p><span><?php echo aboutEmail(1) ?></span> <a href="mhilmit@gmail.com"><?php echo aboutDesEmail(1) ?></a></p>
                        </div>
                    </div>
                    <div class="dbox w-100 d-flex">
