        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-12 heading-section text-center ftco-animate mb-5">
                    ...
                    <h2 class="mb-4">do awesome services for clients</h2>
                    <p>Here my service for my beloved client</p>
                </div>
            </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="media block-6 services d-block bg-white rounded-lg shadow ftco-animate">
                        ...
                        <div class="media-body">
                            <h3 class="heading mb-3"><?php echo titleServices(1); ?></h3>
                            <p><?php echo textServices(1); ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="media block-6 services d-block bg-white rounded-lg shadow ftco-animate">
                        ...
                        <div class="media-body">
                            <h3 class="heading mb-3"><?php echo titleServices(2); ?></h3>
                            <p><?php echo textServices(2); ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="media block-6 services d-block bg-white rounded-lg shadow ftco-animate">
                        ...
                        <div class="media-body">
                            <h3 class="heading mb-3"><?php echo titleServices(3); ?></h3>
                            <p><?php echo textServices(3); ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="media block-6 services d-block bg-white rounded-lg shadow ftco-animate">
                        ...
                        <div class="media-body">
                            <h3 class="heading mb-3"><?php echo titleServices(4); ?></h3>
                            <p><?php echo textServices(4); ?></p>
                        </div>
                    </div>
                </div>
            </div>
