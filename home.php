            ...
            <div class="slider-item">
                ...
                <div class="container-fluid px-md-0">
                    <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
                        <div class="one-third order-md-last img" style="background-image:url(imagesHTML/background1.JPG);">
                            <div class="overlay"></div>
                            <div class="overlay-1"></div>
                        </div>
                        <div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                            <div class="text" id="homeContainer">

                                <span class="subheading"><?php echo homeJob(1); ?></span>
                                <h1 class="mb-4 mt-3"><?php echo homeNama(1); ?></h1>


                                <p><a class="btn btn-primary btn-outline-primary">Download CV</a>
                                </p>
                            </div>
                        </div>
                    </div>
